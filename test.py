...
def analyze_frame_A(frame, class_name, confidence_score, emotions_over_time, ages_over_time, genders_over_time, check_time):
    try:
        analyze = DeepFace.analyze(frame, actions=['emotion', 'gender'], enforce_detection=False)
        ...
        return {
            ...
            'emotion': emotion,'gender': gender, 'gender_confidence': gender_confidence
        }
...
previous_results = {
    ...
    'class_name1': '', 'confidence_score1': 0, 'emotion1': '', 'gender1': '', 'gender_confidence1': 0
}
...
if genders_over_time:
    ...
    title_text = f"Emotion Wave Over Time in Cam0 (Gender: {most_common_gender} {gender_confidence_avg:.2f}%)"
else:
    title_text = "Emotion Wave Over Time"

if genders_over_time1:
    ...
    title_text1 = f"Emotion Wave Over Time in Cam1 (Gender: {most_common_gender1} {gender_confidence_avg1:.2f}%)"
else:
